...
import { buildResetPasswordEmail, buildVerificationEmail, buildWelcomeEmail, sendEmailWithFallback } from "../../email/email.service.js";
import { UserRepository } from "../repositories/user.repository.js";

export class AuthService {
  constructor(private readonly userRepository = new UserRepository()) {}

  async signup(input: { name: string; email: string; password: string; workspaceName: string }) {
