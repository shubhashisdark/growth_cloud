...
leadsRouter.post(
  ...
  async (request, response) => {
    ...
    if (typeof request.body === "string") {
      ...
      body = typeof (request.body as { csvText?: unknown }).csvText === "string"
        ? (request.body as { csvText?: string }).csvText ?? ""
...
leadsRouter.get(
  ...
  async (request, response) => {
    ...
    if (!detail) return sendError(response, "NOT_FOUND", "Lead not found", 404);
...
leadsRouter.post(
  "/",
  requireAuth,
  requireWorkspaceMember(["super_admin", "admin", "marketer", "developer", "sales"]),
  async (request, response) => {
...
leadsRouter.patch(
  ...
  async (request, response) => {
    ...
    if (!updated) return sendError(response, "NOT_FOUND", "Lead not found", 404);
...
leadsRouter.delete(
  ...
  async (request, response) => {
    ...
    if (!result) return sendError(response, "NOT_FOUND", "Lead not found", 404);
    return sendSuccess(response, result);
  }
);
...
leadsRouter.post(
  ...
  async (request, response) => {
    ...
    if (!note) return sendError(response, "NOT_FOUND", "Lead not found", 404);
...
leadsRouter.post(
  ...
  async (request, response) => {
    ...
    if (!activity) return sendError(response, "NOT_FOUND", "Lead not found", 404);
...
leadsRouter.post(
  ...
  async (request, response) => {
    ...
    if (!lead) return sendError(response, "NOT_FOUND", "Lead not found", 404);
    ...
    const currentTags: string[] = JSON.parse(lead.tagsJson ?? "[]");
