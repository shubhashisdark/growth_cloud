...
export function createTokenValue(prefix: string) {
...
export function createKeyMaterial(type: "secret" | "public") {
...
export function createVerificationTokenMaterial(type: "email_verification" | "password_reset" | "refresh_session") {
...
export function verifyAccessTokenSignature(token: string) {
